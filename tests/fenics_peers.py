...
V = FunctionSpace(mesh, MixedElement([_H,_B,_H,_B,R]))

# -------------------------------------------------------------------
# define variational problem

# trial functions
trial_func = TrialFunction(V) 
(sig1_H, pre_sig1_B, sig2_H, pre_sig2_B, r) = split(trial_func)
sig1_B = as_vector([pre_sig1_B.dx(1),-pre_sig1_B.dx(0)])
sig2_B = as_vector([pre_sig2_B.dx(1),-pre_sig2_B.dx(0)])

# test functions
test_func = TestFunction(V)
(tau1_H, pre_tau1_B, tau2_H, pre_tau2_B, s) = split(test_func)
...
# -------------------------------------------------------------------
# plot solution
(sig1_H, pre_sig1_B, sig2_H, pre_sig2_B, r) = split(U)
sig1_B = as_vector([pre_sig1_B.dx(1),-pre_sig1_B.dx(0)])
sig2_B = as_vector([pre_sig2_B.dx(1),-pre_sig2_B.dx(0)])
